...
const TimeDisplay = ({ currentTime }) => (
  <div className="text-sm ms-1 mt-1 font-medium">{currentTime}</div>
);
...
const NumericKeyboard = ({ handleButtonClick, handleCallClick }) => (
  <>
    ...
    <div className="flex justify-center mb-10">
      <button
        className="rounded-full bg-green-500 text-white p-3 call-touch"
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-200 flex-col md:flex-row">
      {(showVideo && (
        ...
        <div className="iphone-frame border-8 border-black w-64 overflow-hidden h-[500px] bg-white relative flex flex-col">
          ...
          <input
            type="text"
            className="text-center mx-auto mt-auto text-xl"
